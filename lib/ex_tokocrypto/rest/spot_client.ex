defmodule ExTokocrypto.Rest.SpotClient do
  ...
  def put(path, params, %Credentials{} = credentials, opts \\ []) when is_map(params) do
    HTTPClient.spot_endpoint() |> HTTPClient.put(path, params, credentials, opts)
  end
end
