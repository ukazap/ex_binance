defmodule ExTokocrypto.Rest.HTTPClient do
  alias ExTokocrypto.{Auth, Credentials}
  ...
  # tokocrypto
  defp parse_response_body({:ok, %{"code" => 0, "msg" => "Success"}} = result), do: result

  defp parse_response_body({:ok, %{"code" => _} = reason}),
    do: {:error, {:tokocrypto_error, reason}}
  ...
  def spot_domain do
    Application.get_env(:ex_tokocrypto, :spot_domain, "www.tokocrypto.com")
  end

  def usd_margin_futures_domain do
    Application.get_env(:ex_tokocrypto, :usd_margin_futures_domain, "www.tokocrypto.com")
  end

  def coin_margin_futures_domain do
    Application.get_env(:ex_tokocrypto, :coin_margin_futures_domain, "www.tokocrypto.com")
  end
end
